<?php
class Default_action_Detail_d321fce58c0948c5 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '<div class="container px-4 py-5">
  <div class="row row-cols-1 row-cols-lg-2" style="padding: 0px 300px">
