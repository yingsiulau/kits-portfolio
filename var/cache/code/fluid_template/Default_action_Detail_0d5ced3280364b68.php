<?php
class Default_action_Detail_0d5ced3280364b68 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '<div class="container px-4 py-5">
  <div class="row row-cols-1 row-cols-lg-2 if-card" style="padding: 12px 24px">
