<?php
class Default_action_Detail_6f18bfbd9d64fbba extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '<div class="container px-4 py-5">
  <div class="row row-cols-1 row-cols-lg-2" style="padding: 10px 24px">
...
$output13 .= '
        <div class="col no-margin" style="padding: 14px 12px">
          ';
// Rendering ViewHelper TYPO3Fluid\Fluid\ViewHelpers\Format\RawViewHelper
