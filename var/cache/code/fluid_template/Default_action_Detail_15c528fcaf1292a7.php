<?php
class Default_action_Detail_15c528fcaf1292a7 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '<div class="container px-4 py-5">
  <div class="row row-cols-1 row-cols-lg-2 " style="padding: 12px 24px">
    <div class="col-12 col-lg-4 order-lg-2 if-card">
